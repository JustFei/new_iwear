...
//睡眠图表
/** 浅睡 */
#define SLEEP_CURRENT_LOW_SLEEEP_BAR COLOR_WITH_HEX(0xb388ff,0.54)
/** 浅睡选中 */
#define SLEEP_CURRENT_LOW_SLEEEP_SELECT_BAR COLOR_WITH_HEX(0xb388ff,0.87)
/** 深睡 */
#define SLEEP_CURRENT_DEEP_SLEEEP_BAR COLOR_WITH_HEX(0x651fff,0.54)
/** 深睡选中 */
#define SLEEP_CURRENT_DEEP_SLEEEP_SELECT_BAR COLOR_WITH_HEX(0x651fff,0.87)
/** 清醒 */
#define SLEEP_CURRENT_CLEAR_SLEEEP_BAR COLOR_WITH_HEX(0xffbc00,0.54)
/** 清醒选中 */
#define SLEEP_CURRENT_CLEAR_SLEEEP_SELECT_BAR COLOR_WITH_HEX(0xffbc00,0.87)
