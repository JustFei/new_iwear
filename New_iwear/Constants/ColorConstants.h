...
//睡眠图表
/** 浅睡 */
#define SLEEP_CURRENT_LOW_SLEEEP_BAR COLOR_WITH_HEX(0x673ab7,0.38)
/** 浅睡选中 */
#define SLEEP_CURRENT_LOW_SLEEEP_SELECT_BAR COLOR_WITH_HEX(0x673ab7,0.6)
/** 深睡 */
#define SLEEP_CURRENT_DEEP_SLEEEP_BAR COLOR_WITH_HEX(0x311b92,0.54)
/** 深睡选中 */
#define SLEEP_CURRENT_DEEP_SLEEEP_SELECT_BAR COLOR_WITH_HEX(0x311b92,0.87)
/** 清醒 */
