...
#define STEP_HISTORY_BACKGROUND_COLOR COLOR_WITH_HEX();

/** 心率页面 */
#define HR_CURRENT_BACKGROUND_COLOR COLOR_WITH_HEX();
#define HR_HISTORY_BACKGROUND_COLOR COLOR_WITH_HEX();

/** 睡眠页面 */
#define SLEEP_CURRENT_BACKGROUND_COLOR COLOR_WITH_HEX();
#define SLEEP_HISTORY_BACKGROUND_COLOR COLOR_WITH_HEX();

/** 血压页面 */
#define BP_CURRENT_BACKGROUND_COLOR COLOR_WITH_HEX();
#define BP_HISTORY_BACKGROUND_COLOR COLOR_WITH_HEX();

/** 血氧页面 */
#define BO_CURRENT_BACKGROUND_COLOR COLOR_WITH_HEX();
#define BO_HISTORY_BACKGROUND_COLOR COLOR_WITH_HEX();
