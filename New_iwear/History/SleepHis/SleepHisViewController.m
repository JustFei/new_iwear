...
@interface SleepHisViewController ()< PNChartDelegate >
{
    NSInteger sumStep;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationController.navigationBar.barTintColor = SLEEP_HISTORY_BACKGROUND_COLOR;
}
...
- (void)initUI
{
    ...
    [self.mileageAndkCalLabel setText:@"深睡2.2小时/浅睡5小时"];
    ...
    [hisBtn setTitleColor:TEXT_WHITE_COLOR_LEVEL4 forState:UIControlStateNormal];
    ...
    [_view2MileageLabel setText:@"2.2小时"];
