...
- (void)SGQRCodeInformationFromeAibum:(NSNotification *)noti {
    ...
    self.alert = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"tips", nil) message:string preferredStyle:UIAlertControllerStyleAlert];
    ...
    UIAlertAction *contentAC = [UIAlertAction actionWithTitle:NSLocalizedString(@"bind", nil) style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        //连接设备
