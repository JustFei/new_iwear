...
#pragma mark - - - 扫描外部View的创建
    ...
    promptLabel.text = NSLocalizedString(@"putQrCode", nil);
    ...
    [light_button setTitle:NSLocalizedString(@"openFlash", nil) forState:UIControlStateNormal];
    [light_button setTitle:NSLocalizedString(@"closeFlash", nil) forState:UIControlStateSelected];
